...
for i=1:nfile
    ...
    if isK2
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Knife','LineWidth',2,'Color','green','TextBoxOpacity',0.6);
            knife2B(r,c) = 1;
        end
    end
    ...
    if isK3
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Knife','LineWidth',2,'Color','blue','TextBoxOpacity',0.6);
            knife3B(r,c) = 1;
        end
    end
    ...
    if isG1 
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Gun','LineWidth',2,'Color','black','TextBoxOpacity',0.6,'TextColor','white');
            gun1B(r,c) = 1;
        end
    end
    ...
    if isG2
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Gun','LineWidth',2,'Color','magenta','TextBoxOpacity',0.6);
            gun2B(r,c) = 1;
        end
    end
    ...
    if isG3
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Gun','LineWidth',2,'Color','cyan','TextBoxOpacity',0.6);
            gun3B(r,c) = 1;
        end
    end
    ...
    if isG4
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Gun','LineWidth',2,'Color','green','TextBoxOpacity',0.6);
            gun4B(r,c) = 1;
        end
    end
    ...
    if isG5
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Gun','LineWidth',2,'Color','blue','TextBoxOpacity',0.6);
            gun5B(r,c) = 1;
        end
    end
    ...
    if isG6
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Gun','LineWidth',2,'Color','red','TextBoxOpacity',0.6);
            gun6B(r,c) = 1;
        end
    end
    ...
    if isW2
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Wrench','LineWidth',2,'Color','black','TextBoxOpacity',0.6);
            wrench2B(r,c) = 1;
        end
    end
    ...
    if isP1
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Pliers','LineWidth',2,'Color','magenta','TextBoxOpacity',0.6);
            pliers1B(r,c) = 1;
        end
    end
    ...
    if isP2
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Pliers','LineWidth',2,'Color','cyan','TextBoxOpacity',0.6);
            pliers2B(r,c) = 1;
        end
    end
    ...
    if isS1
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Scissor','LineWidth',2,'Color','red','TextBoxOpacity',0.6);
            scissor1B(r,c) = 1;
        end
    end
    ...
    if isS2
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Scissor','LineWidth',2,'Color','green','TextBoxOpacity',0.6);
            scissor2B(r,c) = 1;
        end
    end
    ...
    if isS4
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Scissor','LineWidth',2,'Color','blue','TextBoxOpacity',0.6);
            scissor4B(r,c) = 1;
        end
    end
    ...
    if isS5
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Scissor','LineWidth',2,'Color','black','TextBoxOpacity',0.6);
            scissor5B(r,c) = 1;
        end
    end
    ...
    if isH1
        ...
        for j = 1:max(max(L))
            ...
            im2 = insertObjectAnnotation(im2,'Rectangle',[minX,minY,maxX-minX,maxY-minY],'Hammer','LineWidth',2,'Color','magenta','TextBoxOpacity',0.6);
            hammer1B(r,c) = 1;
        end
    end
    ...
    saveas(gcf,['results\sixray\examples\' fn],'png');
end