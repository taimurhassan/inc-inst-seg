# Note: This code is orignally adopted from Divam Gupta's GitHub repository and some parts have been modified by us. Many thanks to her and her team for this
...
def get_segmentation_model(input, output, addActivation = True):
