# Note: This code is originally adopted from Divam Gupta's GitHub repository and some parts have been modified by us. Many thanks to her and her team for this
import glob
import random
import json
import os
...
def evaluate( model=None , inp_images=None , annotations=None,inp_images_dir=None ,annotations_dir=None , checkpoints_path=None ):
    ...
    return {"frequency_weighted_IoU":f_weighted_iou , "mean_IoU":mean_IoU , "class_wise_IoU":iou }
